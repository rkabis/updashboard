export default (
	...
	switch(mapdata) {
		...
		case 'wifi':
			return "<strong>Building: </strong>" + feature.properties.wifiBuilding + "<br/>" + feature.properties.wifiFloor + "<br/><br/><strong>DILNIT: </strong>" + feature.properties.wifiDILNET + "<br/><strong>ENGGNET: </strong>" + feature.properties.wifiENGGNET + "<br/><strong>WIFI@UPD: </strong>" + feature.properties.wifiWIFIUPD + "<br/><br/><strong>Restrictions: </strong><br/>(DILNET)<br/>DilNet Account through portal.upd.edu.ph<br/>(ENGGNET)<br/>DilNet Account through 10.150.0.10/tohttps.jsp<br/>(WiFi@UPD)<br/>none"
		case 'utility':
		...
		case 'library':
			if (feature.properties.discAmenities) {
				return "<strong>" + feature.properties.libName + "</strong><br/><a href='" + feature.properties.libSite + "'>" + feature.properties.libSite + "</a><br/><br/><strong>Lunch Break: </strong>" + feature.properties.libBreak + "<br/><strong>Weekday Hours: </strong>" + feature.properties.libHrs + "<br/><strong>Saturday Hours: </strong>" + feature.properties.libHr	+ "<br/><br/><strong>Discussion Room: </strong><br/>" + feature.properties.discAmenities + "<br/>" + feature.properties.disAReservation + "<br/>Max: " + feature.properties.discMax + "<br/>Min: " + feature.properties.discMin + "<br/>Extensions: " + feature.properties.discMaxRes
			} else {
